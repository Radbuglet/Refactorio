...
namespace Refactorio.game.scripting
{
    public static class Parser
    {
        ...
        public static Rt Parse(string code)
        {
            ...
            expr3 = expr2
                .Or(Binary(">", Rt.BinaryOperator.Add, expr2, expr2))
                .Or(Binary("<", Rt.BinaryOperator.Add, expr2, expr2))
                .Or(Binary("==", Rt.BinaryOperator.Sub, expr2, expr2));
            ...
            var conditional = condition
                .AndIgnore(C.Expect(",").AndIgnore(Whitespace).Or(C.Expect("")))
                .Repeat()
                .SurroundedBy(
                    C.Expect("(").And(Whitespace),
                    C.Expect(")").And(Whitespace))
                .Or(C.Pure(new Array<Rt.Condition>()));
            ...
            var events = new Dictionary<string, Array<Runtime.ConditionalInstruction>>();
